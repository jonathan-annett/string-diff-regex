...
(function(
    ...
    sha1     // sha1 hash for integrity checks
            ...
            if (start===0) {
                ...
                if (end===0) {
                    ...
                    */
                    ...
                    if (l_b===start) {
                        del = l_a-l_b;
                        return retcheck(['(?<=.{'+start+'}).{'+del+'}','',h,"diff_shrink: start!==0,end!==0"]);
                    }
        ...
        if (isNodeJS) {
            ...
            var test = {"a":"///\nconsole.log(\"this is input 2\");\n\nfunction someFile4(inject){\"input4.js\";}\n\nfunction someFile8(inject){\"subdir/input8.js\";}\n\n\nvar a = {\n\"a\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\",\n\"b\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\",\n\"d\":[\"(?<=.{129}).{0}\",\"\",\"30f4921dc0bc24d523ae95fe4efbf3429d48e17c\",\"diff_shrink: start!==0,end!==0\"],\n\"r\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\"}\n\n\n\n\n\n\n\n\n","b":"///\nconsole.log(\"this is input 2\");\n\nfunction someFile4(inject){\"input4.js\";}\n\nfunction someFile8(inject){\"subdir/input8.js\";}\n\n\nvar a = {\n\"a\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\",\n\"b\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\",\n\"d\":[\"(?<=.{129}).{0}\",\"\",\"30f4921dc0bc24d523ae95fe4efbf3429d48e17c\",\"diff_shrink: start!==0,end!==0\"],\n\"r\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\"}\n\n\n\n\n","d":["(?<=.{708}).{2}","","e91c5e071409429c29df48e7f2695bfa7947d019","diff_shrink: start!==0,end!==0"],"r":"///\nconsole.log(\"this is input 2\");\n\nfunction someFile4(inject){\"input4.js\";}\n\nfunction someFile8(inject){\"subdir/input8.js\";}\n\n\nvar a = {\n\"a\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\",\n\"b\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\",\n\"d\":[\"(?<=.{129}).{0}\",\"\",\"30f4921dc0bc24d523ae95fe4efbf3429d48e17c\",\"diff_shrink: start!==0,end!==0\"],\n\"r\":\"///\\nconsole.log(\\\"this is input 2\\\");\\n\\nfunction someFile4(inject){\\\"input4.js\\\";}\\n\\nfunction someFile8(inject){\\\"subdir/input8.js\\\";}\\n\\n\\n\\n\\n\"}\n\n\n\n\n\n\n"}
            diff (test.a,test.b);
